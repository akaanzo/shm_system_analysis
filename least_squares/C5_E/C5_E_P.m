...
% Linux
Sdata=xlsread('../../data/FBG_C5_E_P.xlsx'); % Box girder
...
save './P/Sdata.mat' Sdata;
save './P/Tdata.mat' Tdata;

%% Loading mat files

fprintf('LOADING mat FILES...\n');

load './P/Sdata.mat' Sdata;
load './P/Tdata.mat' Tdata;
...
% ETHETA
save './P/export/ETHETA.mat' ETHETA;
writematrix(ETHETA, './P/export/ETHETA.csv')

% COVARIATION MATRIX
save './P/export/SIGMA.mat' SIGMA;
writematrix(SIGMA, './P/export/SIGMA.csv')

% STD
STD = [sqrt(SIGMA(1,1)), sqrt(SIGMA(2,2)), sqrt(SIGMA(3,3))];
save './P/export/STD.mat' STD;
writematrix(STD, './P/export/STD.csv')

% CORRELATION MATRIX
save './P/export/RO.mat' RO;
writematrix(RO, './P/export/RO.csv')
